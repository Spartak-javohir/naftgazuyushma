import DMA from "../pages/tahlil/img/DMA.png";
import Areometr from "../pages/tahlil/img/areometr.png";
import Arn from "../pages/tahlil/img/arn.png";
import Arnlab from "../pages/tahlil/img/arnlab.png";
import Astm from "../pages/tahlil/img/astm.png";
import Chaqnash from "../pages/tahlil/img/chaqnash.png";
import Dina from "../pages/tahlil/img/dina.png";
import Englar from "../pages/tahlil/img/englar.png";
import Formula from "../pages/tahlil/img/formula.png";
import Haake from "../pages/tahlil/img/haake.png";
import Koehlar from "../pages/tahlil/img/koehlar.png";
import Spek from "../pages/tahlil/img/spek.png";
import Vpj from "../pages/tahlil/img/vpj.png";
import Yopiqtigel from "../pages/tahlil/img/yopiqtigel.png";
